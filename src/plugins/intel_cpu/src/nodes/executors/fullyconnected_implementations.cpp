...
static const TypeMapping dnnlFCTypeMapping {
    ...
    {{_bf16, _u8 | _i8 | _nf4 | _u4 | _i4 | _f4e2m1 | _u2 | _u3, _any, _any},       {bypass(), bypass(), use<0>(), use<0>()},
    ...
    {{_f32,  _u8 | _i8 | _nf4 | _u4 | _i4 | _f4e2m1 | _u2 | _u3, _any, _any},       {bypass(), bypass(), use<0>(), use<0>()}},
