...
#include "transformations/snippets/common/pass/brgemm_to_brgemm_cpu.hpp"
...
#if defined(OPENVINO_ARCH_ARM64)
    subgraph_attrs->snippet->set_generator(std::make_shared<aarch64::CPUGenerator>(host_isa, context->getParamsCache()));
...
#    define SNIPPETS_REGISTER_PASS_RELATIVE_X86_64(PASS_PLACE, TARGET_PASS, PASS, ...)
    ...
    SNIPPETS_REGISTER_PASS_RELATIVE_COMMON(Place::Before, ov::snippets::pass::PropagatePrecision,
